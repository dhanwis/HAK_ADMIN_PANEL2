          ...
          <div class="logo position-relative">
            <a href="/">
              {/* <!-- Logo can be added directly --> */}
               <img src="img/dil-hak.png" alt="logo" style={{marginLeft:'-30px '}} /> 
              ...
              <li>
                ...
                <ul id="admin">
                  ...
                  <Link to="/product-admin">
                      <span class="label">Product Admin</span>
                      </Link>
                  </li>
                  <li>
                    <a href="/order-admin">
                      <span class="label">Order Admin</span>
                    </a>
                  </li>
                  <li>
                    <a href="/sales-admin">
                      <span class="label">Sales Admin</span>
                    </a>
                  </li>
